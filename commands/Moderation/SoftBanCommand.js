...
module.exports = class SoftBanCommmand extends BaseCommand {
    constructor() {
        super(
            "softban",
            "Moderation",
            ["softbye"],
            "Bans and unbans a specified member with a reason",
                            ...
                            member
                                ...
                                .then(() => {
                                    const logEmbed = new MessageEmbed()
                                        .setColor(theme.dataValues.embedTheme)
                                        .setFooter(`Banned & Unbanned Member`, member.user.displayAvatarURL)
                                        .addField(
                                            "Banned Member",
